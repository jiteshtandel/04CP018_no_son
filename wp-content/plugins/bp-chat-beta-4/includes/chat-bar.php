...
<div class="bp_chatbar" id="bp_chatbar">
        <div id="bp_chat_base">
                ...
                <div class="chat_window">
                    ...
                    <div class="win_header">
                        <a class="win_header_image_link" href="#">
                            <img title="View Profile" class="img" src="" alt="" width="23" height="23" />
                        </a>
            ...
            <div class="chat_buddylist" id="chat_buddylist">
                <div id="settings_tab" class="chat_tab" align="left">
                    <div  class="chat_button">
                        <div class="rule">
                            <div class="tab_content bc_block">
                                <span class="tab_name">
                                    Chat (<span class="online_count"><?php echo intval(bpchat_get_online_users_count());?></span>)
                                </span>								
                            </div>
                        </div>
                     </div>
                    ...
                    <div class="chat_window">
                        <div class="win_titlebar">
                            <label class="close close_button">
                             ...
                             <div class="win_title_text" style="margin-left:0px;">
                                 <?php if( bpchat_show_user_preference() ): ?>
                                    <a class="win_title_text_link" id="win_title_text_link_settings" href="#">Chat</a>
                         ...
                         <div class="win_header">
                            ...
                            <div class="win_body" style="min-height: 130px;max-height:400px;">
                               <div class="win_content">
...
function create_chat_window($channel,$toggle_class=''){
    ?>
 <div id="chat_channel_<?php echo $channel->channel_id;?>" class="chat_tab   <?php echo $toggle_class;?> " style="width: 230px;" test="test">
	
	<div class="chat_button">
		<div class="rule">
                    <div class="tab_content bc_block" align="left">
			<span class="tab_name">
          ...
          <div class="chat_window">
            ...
            <div class="win_header">
                <a class="win_header_image_link" href="<?php echo bp_core_get_user_domain($channel->user_id);?>">
                       <?php echo  bp_core_fetch_avatar(array('item_id' => $channel->user_id, 'type' => 'thumb', 'width' => 23, 'height' =>23, 'html' => true));?>
                </a>
               <!-- <div class="win_header_info">....</div> -->
                 <div class="win_toolbox">
                       <div class="win_toolbar_items disabled"></div>
