...
?>
    <tr> 
        <td valign="top" align="left" id="container" style="padding-right:15px;padding-left: 30px;">
            <div class="page_tital_text"><?php _e( 'Search Results', 'knowtion' ); ?></div>
                        ...
                        <td valign="top" align="left" id="content" style="padding-left:0px;">
                            <div id="searchbox">
                                <div style="padding:8px;">
                                    <div style="font-size:17px;"><?php _e( 'Filter Results', 'knowtion' ); ?></div>                        
                                            ...
                                            <table cellpadding="0" cellspacing="0" border="0" style="width:100%;" id="searchoptions">
                                                <tr>
                                                    <td valign="top" colspan="2">
                                                        <div><?php _e( 'Languages Spoken', 'knowtion' ); ?></div>
                                                    ...
                                                    <td valign="top" colspan="2">
                                                        <div><?php _e( 'Languages Learning', 'knowtion' ); ?></div>
                                                        <div style="height:5px;"><!-- --></div>	
                                                        <div>
                                                ...
                                                <tr>
                                                    <td valign="top" style="width: 20%">
                                                        <div><?php _e( 'Age', 'knowtion' ); ?></div>
                                                        <div style="height:5px;"><!-- --></div>	
                                                        <div>
                                                            <select id="age" name="age" style="width: 85%;">
                                                                <option value=""><?php _e( 'Select Age', 'knowtion' ); ?></option>
                                                    ...
                                                    <td valign="top" style="width: 22%">
                                                        <div><?php _e( 'Gender', 'knowtion' ); ?></div>
                                                        <div style="height:5px;"><!-- --></div>	
                                                        <div>
                                                            <select id="gender" name="gender" style="width: 85%">
                                                                <option value=""><?php _e( 'Select Gender', 'knowtion' ); ?></option>
                                                                <option value="Male" <?php echo ($gender=='Male')? 'selected="selected"' : '';?>><?php _e( 'Male', 'knowtion' ); ?></option>
                                                                <option value="Female" <?php echo ($gender=='Female')? 'selected="selected"' : '';?>><?php _e( 'Female', 'knowtion' ); ?></option>
                                                            </select>
                                                        </div>
                                                    </td>
                                                    <td valign="top" style="width: 24%">
                                                        <div>
                                                            <div><?php _e( 'Search', 'knowtion' ); ?></div>
                                                            <div style="height:5px;"><!-- --></div>	
                                                            <div>
                                                    ...
                                                    <td valign="middle" style="width: 17%">
                                                        <div style="padding-top:18px;">
                                                            ...
                                                            <label for="native"><?php _e( 'Native Speaker', 'knowtion' ); ?></label>
                                                        </div>
                                                    </td>
                                                    <td valign="top" align="right">
                                                        <div style="padding-top:25px;"><input id="search" name="search" class="green-button" value="<?php _e( 'Search', 'knowtion' ); ?>" type="submit"/></div>
                                                    </td>
                                                </tr>
                                            </table>	
                                        </form>
                                                ...
                                                <div class="item-list-tabs" id="subnav" role="navigation">
                                                        <ul>
                                                                ...
                                                                <li id="members-order-select" class="last filter">
                                                                        <label for="members-order-by"><?php _e( 'Order By:', 'knowtion' ); ?></label>
                                                                        <select id="members-order-by">
                                                                                <option value="active"><?php _e( 'Last Active', 'knowtion' ); ?></option>
                                                                                <option value="newest"><?php _e( 'Newest Registered', 'knowtion' ); ?></option>

                                                                                <?php if ( bp_is_active( 'xprofile' ) ) : ?>
                                                                                        <option value="alphabetical"><?php _e( 'Alphabetical', 'knowtion' ); ?></option>
                                                                                <?php endif; ?>
