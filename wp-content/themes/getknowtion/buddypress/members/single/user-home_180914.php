<?php
    ...
    $homepagepath=bp_loggedin_user_domain();
?>
<tr>
            ...
            <tr>
                <td valign="top" align="left" id="leftbar">
                    <div class="userinfo">
                        ...
                        <a href="<?php echo $homepagepath . 'profile/';?>" class="username"><?php echo bp_loggedin_user_fullname();?></a></br>
                        <a href="<?php echo $homepagepath . 'profile/edit';?>" class="edit-profile">Edit Profile</a>
                        <div class="clearboth"></div>
                    </div>    
                    <div class="left-site-menu">
                        <ul class="menu-items">
                            <li class="<?php echo (in_array($currentaction, array('just-me','friends'))) ? 'current-page-item' : 'page-item'; ?>">
                                <a href="<?php echo $homepagepath;?>">Home</a>
                            </li>
                            <li class="page-item">
                                <a href="#">Manage my calender</a>
                            </li>
                             <li class="page-item">
                ...
                <td valign="top" align="left" id="content">
                    	<div class="learning-option">
                            ...
                            <div style="padding:10px 0px 0px 45px;">
                                <a class="greentext15" href="<?php echo site_url(); ?>/members/">Browse Language Partners</a>
                                <div class="blacktext12">Search for language partners in your target languages.</div>
                                <div class="height15"><!-- --></div>
                                <div class="greentext15">Schedule a Lesson</div>
