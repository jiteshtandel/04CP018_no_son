<?php
    ...
    $activitycount=0;
?>
    <?php if ( bp_has_activities( bp_ajax_querystring( 'activity' ).'&per_page=' . PER_PAGE_RECORDS . '&scope=just-me&action=activity_update' ) ) { ?>
	...
	<?php while ( bp_activities() ) : bp_the_activity(); ?>
		<?php 
                    $activitycount++;
                    bp_get_template_part( 'activity/member-entry' ); 
                ?>
