...
<form id="bbp-your-profile" action="<?php bbp_user_profile_edit_url( bbp_get_displayed_user_id() ); ?>" method="post" enctype="multipart/form-data">
	...
	<h2 class="entry-title"><?php _e( 'Name', 'knowtion' ) ?></h2>

	<?php do_action( 'bbp_user_edit_before' ); ?>

	<fieldset class="bbp-form">
		<legend><?php _e( 'Name', 'knowtion' ) ?></legend>

		<?php do_action( 'bbp_user_edit_before_name' ); ?>

		<div>
			<label for="first_name"><?php _e( 'First Name', 'knowtion' ) ?></label>
		...
		<div>
			<label for="last_name"><?php _e( 'Last Name', 'knowtion' ) ?></label>
		...
		<div>
			<label for="nickname"><?php _e( 'Nickname', 'knowtion' ); ?></label>
		...
		<div>
			<label for="display_name"><?php _e( 'Display Name', 'knowtion' ) ?></label>
	...
	<h2 class="entry-title"><?php _e( 'Contact Info', 'knowtion' ) ?></h2>

	<fieldset class="bbp-form">
		<legend><?php _e( 'Contact Info', 'knowtion' ) ?></legend>

		<?php do_action( 'bbp_user_edit_before_contact' ); ?>

		<div>
			<label for="url"><?php _e( 'Website', 'knowtion' ) ?></label>
	...
	<h2 class="entry-title"><?php bbp_is_user_home_edit() ? _e( 'About Yourself', 'knowtion' ) : _e( 'About the user', 'knowtion' ); ?></h2>

	<fieldset class="bbp-form">
		<legend><?php bbp_is_user_home_edit() ? _e( 'About Yourself', 'knowtion' ) : _e( 'About the user', 'knowtion' ); ?></legend>

		<?php do_action( 'bbp_user_edit_before_about' ); ?>

		<div>
			<label for="description"><?php _e( 'Biographical Info', 'knowtion' ); ?></label>
	...
	<h2 class="entry-title"><?php _e( 'Account', 'knowtion' ) ?></h2>

	<fieldset class="bbp-form">
		<legend><?php _e( 'Account', 'knowtion' ) ?></legend>

		<?php do_action( 'bbp_user_edit_before_account' ); ?>

		<div>
			<label for="user_login"><?php _e( 'Username', 'knowtion' ); ?></label>
		...
		<div>
			<label for="email"><?php _e( 'Email', 'knowtion' ); ?></label>
		...
		<div id="password">
			<label for="pass1"><?php _e( 'New Password', 'knowtion' ); ?></label>
			<fieldset class="bbp-form password">
				...
				<span class="description"><?php _e( 'Type your new password again.', 'knowtion' ); ?></span><br />

				<div id="pass-strength-result"></div>
				<span class="description indicator-hint"><?php _e( 'Your password should be at least ten characters long. Use upper and lower case letters, numbers, and symbols to make it even stronger.', 'knowtion' ); ?></span>
			</fieldset>
		</div>
	...
	<?php if ( current_user_can( 'edit_users' ) && ! bbp_is_user_home_edit() ) : ?>
		...
		<h2 class="entry-title"><?php _e( 'User Role', 'knowtion' ) ?></h2>

		<fieldset class="bbp-form">
			<legend><?php _e( 'User Role', 'knowtion' ); ?></legend>
			...
			<?php if ( is_multisite() && is_super_admin() && current_user_can( 'manage_network_options' ) ) : ?>
				...
				<div>
					<label for="super_admin"><?php _e( 'Network Role', 'knowtion' ); ?></label>
					<label>
						...
						<?php _e( 'Grant this user super admin privileges for the Network.', 'knowtion' ); ?>
					</label>
				</div>
