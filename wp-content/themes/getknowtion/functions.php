...
$TIMEZONEARR=array();
    ...
    $TIMEZONEARR['(GMT -4:00) Atlantic Time (Canada), La Paz, Santiago']=array("seconds"=>-14400);
    ...
    $TIMEZONEARR['(GMT +2:00) Kaliningrad, South Africa, Cairo']=array("seconds"=>+7200);
    ...
    $TIMEZONEARR['(GMT +4:00) Abu Dhabi, Muscat, Yerevan, Baku, Tbilisi']=array("seconds"=>+14400);
    ...
    $TIMEZONEARR['(GMT +6:30) Yangon, Cocos Islands']=array("seconds"=>+23400);
